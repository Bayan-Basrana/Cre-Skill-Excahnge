...
projectsRepository.save(old) ;
    ...
    public void completeProject (Integer projectId , Integer projectOwnerId) {
     ...
     projectsRepository.save(projects);
     //add point to project owner
     ProjectOwner project_owner = projectOwnerRepository.findProjectOwnerByOwnerId(projectOwnerId);
     if(project_owner.getPoints()==null){
         project_owner.setPoints(50);
     }else project_owner.setPoints(project_owner.getPoints()+50);
     projectOwnerRepository.save(project_owner);
     //add point to talent
